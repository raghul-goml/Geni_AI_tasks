...
def chunk_by_json_record(filename, doc_type):
    """Structured JSON chunking - one JSON object becomes one chunk."""
...
INGESTION_PLAN = [
    (chunk_by_paragraph, "about_me.txt", "about_me"),
    (chunk_by_markdown_header, "learning_journey.md", "learning_journey"),
    (chunk_by_json_record, "project.json", "projects"),
    (chunk_by_csv_row, "technologies.csv", "technologies"),
    (chunk_by_paragraph, "technical_knowledge.txt", "technical_knowledge"),
    (chunk_by_paragraph, "coding_preferences.txt", "coding_preferences"),
    (chunk_by_paragraph, "goals.txt", "goals"),
]
