...
Ben 10's Omnitrix knowledge base: Ingestion & Chunking -> Embeddings -> Vector DB & Indexing.
...
def main():
    print("Step 1/2 - Ingestion & Chunking (one strategy per Ben 10 / Omnitrix knowledge type):")
    ...
    print("\nBen 10's Omnitrix knowledge base is ready. Run: streamlit run src/ui/streamlit_app.py")
